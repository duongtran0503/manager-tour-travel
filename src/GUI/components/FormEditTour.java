...
public class FormEditTour extends javax.swing.JFrame {
    ...
    public void setValueEdit(Tour tour) {
       ...
       inputPrice_on_one_persion.setText(tour.getPrice_one_person() +"");
       inputDescription.setText(tour.getDestination_description());
       dateStart.setDate(tour.getTime_book_start());
       dateEnd.setDate(tour.getTime_book_end());
       inpuExpense.setText(tour.getExpense() +"");
       inputQuantity.setText(""+tour.getQuantity());
        setImage(App.globalPathApp +"\\Store_img\\"+tour.getImgUrl());
       nameImage = tour.getImgUrl();
    }
