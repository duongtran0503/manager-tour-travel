 ...
 * @author ACER
 */
public class FormEditTour extends javax.swing.JFrame {

    /**
     * Creates new form FormEditTour
     */
     ...
     */
    public void setValueEdit(String Name,String Address,double price_one_person,String Description,java.sql.Date start,java.sql.Date end,double expense,String image,int quantity) {
       inputName.setText(Name);
       iinputAddress.setText(Address);
       inputPrice_on_one_persion.setText(price_one_person +"");
       inputDescription.setText(Description);
       dateStart.setDate(start);
       dateEnd.setDate(end);
       inpuExpense.setText(expense +"");
       inputQuantity.setText("số lượng chổ còn lại:"+quantity);
        setImage(App.globalPathApp +"\\Store_img\\"+image);
       nameImage = image;
    }
    ...
    private void formValidation() {
     ...
     this.inputPrice_on_one_persion.addFocusListener(new FocusListener(){
       @Override
         public void focusGained(FocusEvent e) {
                inputPrice_on_one_persion.setText("");
                 errorPrice.setText("");
             }

         @Override
         public void focusLost(FocusEvent e) {
             String inputValue =inputPrice_on_one_persion.getText();
             if(!CheckError.isNumber(inputValue) && inputValue.length() >0) {
               errorPrice.setText("không hợp lệ!");
            ...
            if(inputValue.length()==0) {
               errorPrice.setText("không được để trống!");
               errorPrice.setForeground(Color.red);
               isValid = false;
            } else {
             isValid =  true;
     ...
     buttonSubmit.addActionListener(new ActionListener(){
         ...
         public void actionPerformed(ActionEvent e) {
             if(isValid) {
                 ...
                 String valueInputPrice = inputPrice_on_one_persion.getText();
                 ...
                 tourData.setAddress(iinputAddress.getText());
                 tourData.setDestination_description(inputDescription.getText());
                 tourData.setTitle(inputName.getText());
                 tourData.setTime_book_end(dEnd);
                 tourData.setTime_book_start(dStart);
                 tourData.setPrice_one_person(price_one_person);
                 tourData.setExpense(expense);
                 tourData.setImgUrl(nameImage);
                 tourData.setQuantity(Integer.parseInt(inputQuantity.getText()));
 ...
 private  void addEventButtonChangeImage() {
    ...
    private void initComponents() {
        ...
        inputPrice_on_one_persion = new javax.swing.JTextField();
        ...
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 660, 330, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 80, 35));

        inputPrice_on_one_persion.setFont(new java.awt.Font("JetBrains Mono NL Medium", 0, 14)); // NOI18N
        inputPrice_on_one_persion.setBorder(null);
        inputPrice_on_one_persion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inputPrice_on_one_persionActionPerformed(evt);
            }
        });
        jPanel2.add(inputPrice_on_one_persion, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 330, 40));

        jSeparator4.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator4.setForeground(new java.awt.Color(0, 0, 0));
        jSeparator4.setPreferredSize(new java.awt.Dimension(50, 5));
        jPanel2.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 285, 330, -1));
        ...
        errorPrice.setBackground(new java.awt.Color(255, 255, 255));
        errorPrice.setFont(new java.awt.Font("JetBrains Mono", 1, 14)); // NOI18N
        jPanel2.add(errorPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 230, 30));
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 80, 35));

        jSeparator7.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator7.setForeground(new java.awt.Color(0, 0, 0));
        jSeparator7.setPreferredSize(new java.awt.Dimension(50, 5));
        jPanel2.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 570, 330, 20));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 390, 700));
        ...
        buttonSubmit.setText("luu thay đổi");
    ...
    private void inputPrice_on_one_persionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputPrice_on_one_persionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_inputPrice_on_one_persionActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditTour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEditTour().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField inputPrice_on_one_persion;
